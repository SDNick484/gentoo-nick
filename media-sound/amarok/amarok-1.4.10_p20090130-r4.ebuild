...
RDEPEND="
	!<media-sound/amarok-1.4.10_p20090130-r3
...
PATCHES=(
	"${FILESDIR}/${PN}-1.4.10-add-lastfm-recommended-radio.patch"
	"${FILESDIR}/${PN}-1.4.10-fix-autoconf-2.64.patch"
	"${FILESDIR}/${PN}-1.4.10-gcc-4.3.patch"
	"${FILESDIR}/${PN}-1.4.10-gcc44.patch"
	"${FILESDIR}/${PN}-1.4.10-libmp4v2.patch"
	"${FILESDIR}/${PN}-1.4.10-mp4-gcc-fix.patch"
